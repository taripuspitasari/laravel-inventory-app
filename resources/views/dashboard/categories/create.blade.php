...
@section('container')
<form action="/dashboard/categories" method="post" class="grid grid-cols-1">
    @csrf
    ...
    <div class="py-2.5">
        <button type="submit" class="btn w-full max-w-xs text-white bg-primary-600 hover:bg-primary-700">Create Cateogry</button>
    </div>
</form>
@endsection